...
Wishlist_Panel.prototype = {
    ...
    readjustPanelWidth: function(){
        ...
        this.dom_content.parentNode.setStyle({width:parentWidth+"px"});
        this.dom_container.setStyle(
            {width:parentWidth+"px", left:'50%', marginLeft:"-"+(parentWidth/2)+"px"}
        );
    ...
    reloadPanel:function(data){
        ...
        if(data.wishlist_items.length){
            ...
            data.wishlist_items.each(function(e){
                ...
                var maximized_item = "<div class='maximized'><span href='"+e.removeUrl+"' class='btn-remove'>x</span><div style='clear:both;'></div><img src='"+ e.productImage+"'/>"+"<span class='wishlist-marca'>"+e.productBrand+"</span><br/><span class='wishlist-nombre'>"+ e.productName+"</span></div>";
                var item = "<li><a href='"+e.removeUrl+"' class='btn-remove'>x</a><div style='clear:both;'></div> <a class='product' href='"+e.productUrl+"'>"+maximized_item+"<img width='135' src='"+ e.productImage+"'/>"+"<span class='wishlist-marca'>"+e.productBrand+"</span><br/><span class='wishlist-nombre'>"+ e.productName+"</span></a></li>";
