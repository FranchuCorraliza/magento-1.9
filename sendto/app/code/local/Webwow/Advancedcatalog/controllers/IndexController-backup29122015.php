...
class Webwow_Advancedcatalog_IndexController extends Mage_Core_Controller_Front_Action
{
        ...
        public function sendemailAction()
    {
        ...
        $mail->addTo('jesus.it@elitespain.es', 'Elite Store');
        $mail->setSubject('concurso Yeezy Talla '. $params['talla']);
		
		
		$mail2 = new Zend_Mail();
        $mail2->setBodyHtml("Thank you for subscribing! This is to confirm your participation in our YEEZY BOOOST 750 BLACK RAFFLE.<br/> 

Monday is the day! In case you&acute;re one of the lucky winners, we&acute;ll call you and drop you a line with the private link to finish your purchase. <br/>

Until then: FINGERS (AND TOES) CROSSED!<br/>

We wish you a very happy weekend,<br/>

ELITE Store<br/>
<br/>

P.S.<br/>
On Monday, the winners will also be published on <a href='http://www.frivolidays.com'>Frivolidays.com</a> and our social media.
");
        $mail2->setFrom("info@elitestore.es", "Elite Store");
        $mail2->addTo($params['email'], 'Elite Store');
        $mail2->setSubject('CONFIRMATION: YEEZY BOOOST 750 BLACK RAFFLE, SIZE '. $params['talla']);
