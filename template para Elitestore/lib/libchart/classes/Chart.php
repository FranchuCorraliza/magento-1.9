        ...
        */
        ...
        class Chart
        {
                ...
                */
                ...
                {
					//fix for - if point bigger then 7 than point after 8 not include in picture
					if(!empty($this->point) && is_array($this->point) && ($countPoint = count($this->point)) && $countPoint > 7) {
						$this->imageHeight = $this->height + 20*($countPoint-7);
					} else {
						$this->imageHeight = $this->height;
					}
					
					$this->img = imagecreatetruecolor($this->width, $this->imageHeight);
                    ...
                    imagefilledrectangle($this->img, 0, 0, $this->width - 1, $this->imageHeight - 1, $this->backGroundColor->getColor($this->img));
                }
        }
?>
