        ...
        class Text
        {
                ...
                */
                ...
                function Text()
                {
						...
						//$this->fontCondensed = $sfConfig_absolute_path . "/media/DejaVuSansCondensed.ttf";
                       // $this->fontCondensedBold = $sfConfig_absolute_path . "/media/DejaVuSansCondensed-Bold.ttf";
			...
			if (function_exists('html_entity_decode')) {
                ...
                */
				...
				function printCentered2($img, $py, $color, $text, $fontFileName)
                {
                        $this->printText($img, imagesx($img) / 3, $py, $color, $text, $fontFileName, $this->HORIZONTAL_CENTER_ALIGN | $this->VERTICAL_CENTER_ALIGN);
                }
