...
$installer->run("ALTER TABLE `manufacturer`
	ADD COLUMN `imagebanner1` VARCHAR(1) NOT NULL COLLATE 'utf8_unicode_ci',
	ADD COLUMN `default_imagebanner1` TINYINT(1) NOT NULL DEFAULT '1',
    ADD COLUMN `imagebanner2` TINYINT(1) NOT NULL COLLATE 'utf8_unicode_ci',
    ADD COLUMN `default_imagebanner2` TINYINT(1) NOT NULL DEFAULT '1',
    ADD COLUMN `imagebanner3` TINYINT(1) NOT NULL COLLATE 'utf8_unicode_ci',
