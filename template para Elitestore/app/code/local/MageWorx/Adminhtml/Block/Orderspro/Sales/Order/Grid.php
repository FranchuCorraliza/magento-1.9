            ...
            switch ($column) {
                ...
                case 'base_shipping_amount':
                    $this->addColumn('base_shipping_amount', array(
                        'header' => Mage::helper('sales')->__('Base Shipping Amount'),
                ...
                case 'base_subtotal':
                    $this->addColumn('base_subtotal', array(
                        'header' => Mage::helper('sales')->__('Base Subtotal'),
                        'index' => 'base_subtotal',
                        'type'  => 'currency',
                        'currency' => 'base_currency_code',
                    ));
                ...
                case 'status':
					$opciones = Mage::getSingleton('sales/order_config')->getStatuses();
					asort($opciones,2);
					unset($opciones['complete']);
					unset($opciones['reembolsar']);
					unset($opciones['pending_payment']);
					unset($opciones['pending_paypal']);
					unset($opciones['pending']);
					unset($opciones['pendiente_confirmacion_pago']);
					unset($opciones['payment_review']);
					unset($opciones['holded']);
					unset($opciones['no_stock']);
					unset($opciones['importe_parcial_recibido']);
					unset($opciones['defectuoso']);
					//var_dump($opciones);
					//print_r ($opciones);
                    $this->addColumn('status', array(
                        ...
                        'type'  => 'options',
                        'width' => '70px',
                        'options' => $opciones//Mage::getSingleton('sales/order_config')->getStatuses(),
                    ));
                break;
