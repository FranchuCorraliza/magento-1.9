...
class MageWorx_Adminhtml_Model_System_Config_Backend_Orderspro_Menu extends Mage_Core_Model_Config_Data
{
    ...
    protected function _afterSave() {
        ...
        try {
            ...
            if (!$connection->tableColumnExists($resource->getTableName('sales/order_grid'), 'weight')) {
                $connection->delete($resource->getTableName('core/resource'), "code =  'orderspro_setup'");
            }
        } catch (Exception $e) {}        
    }
}
