...
class Mage_Core_Model_Url extends Varien_Object
{
    ...
    public function getUrl($routePath = null, $routeParams = null)
    {
		...
		/**
		* Añadido para eliminar parametros
		**/
		if (is_array($escapeQuery)){
			if (array_key_exists('sc',$escapeQuery)){
				unset($escapeQuery['sc']);
				unset($escapeQuery['manufacturer']);
				unset($escapeQuery['cat']);
			}
		}
		/************/
