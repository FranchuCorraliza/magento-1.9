 ...
 */
class Belitsoft_Survey_Model_Graphic_Pickmany extends Belitsoft_Survey_Model_Graphic
{
...
*/					
		...
		$usr_answers[1] = array(trim(strip_tags('PICKMANY_1')), trim(strip_tags('PICKMANY_2')));		
