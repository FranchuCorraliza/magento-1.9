...
/**
 * Widget to display link to survey page
 *
 * @category   Belitsoft
 * @package    Belitsoft_Survey
 * @author     Mageplace
...
class Belitsoft_Survey_Block_Frontend_Widget_Survey_Link
	...
	implements Mage_Widget_Block_Interface
{
	...
	public function getHref()
	{
		if(!$this->_href) {
			...
			if ($this->getData('href')) {
				...
				$this->_href = Mage::helper('belitsoft_survey')->getSurveyUrl($this->getData('id_path'));
			}
		}
	...
	public function getTitle()
	{
		if (!$this->_title) {
			...
			if ($this->getData('title') !== null) {
				...
				$this->_title = Mage::getResourceSingleton('belitsoft_survey/survey')->getSurveyTitleById($this->getData('id_path'));
			}
		}
	...
	public function getAnchorText()
	{
		if ($this->getData('anchor_text')) {
			...
			$this->_anchorText = Mage::getResourceSingleton('belitsoft_survey/survey')->getSurveyTitleById($this->getData('id_path'));
