    ...
    extends Ess_M2ePro_Model_Connector_Amazon_Requester
{
    ...
    public function checkQtyWarnings()
    {
        foreach ($this->listingsProducts as $listingProduct) {
            ...
            $qtyMode = $listingProduct->getChildObject()->getAmazonSellingFormatTemplate()->getQtyMode();
            if ($qtyMode == Ess_M2ePro_Model_Amazon_Template_SellingFormat::QTY_MODE_PRODUCT_FIXED ||
                $qtyMode == Ess_M2ePro_Model_Amazon_Template_SellingFormat::QTY_MODE_PRODUCT) {
