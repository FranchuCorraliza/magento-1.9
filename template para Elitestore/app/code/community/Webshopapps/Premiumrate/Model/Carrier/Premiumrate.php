    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    {
		Mage::log("getQoute",null,"freeshipping.log");
		...
		Mage::log("Free Shipping:",null,"freeshipping.log");
		Mage::log($request->getFreeShipping(),null,"freeshipping.log");
        if (($version == 1.6 || $version == 1.7 || $version == 1.8 || $version == 1.12 || $version == 1.14) ) {
