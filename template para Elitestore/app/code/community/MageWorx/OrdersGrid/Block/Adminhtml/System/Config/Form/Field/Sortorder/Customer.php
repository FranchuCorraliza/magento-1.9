 ...
 */
class MageWorx_OrdersGrid_Block_Adminhtml_System_Config_Form_Field_Sortorder_Customer extends
...
SCRIPT;
    ...
    {
        return Mage::getUrl('adminhtml/mageworx_ordersgrid/savecustomersortorder');
    }
