...
class MageWorx_OrdersGrid_Model_Observer
{
    ...
    public function updateGrid(Mage_Adminhtml_Block_Sales_Order_Grid $block)
    {
                ...
                case 'product_names':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('product_names', array(
                            ...
                            'index' => 'product_names',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER_ITEMS . '.product_names',
                ...
                case 'product_skus':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('product_skus', array(
                            ...
                            'index' => 'skus',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER_ITEMS . '.skus',
                        ));
                    }
                    break;
                ...
                case 'payment_method':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('payment_method', array(
                            ...
                            'index' => 'method',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_SALES_ORDER_PAYMENT . '.method',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'tracking_number':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('tracking_number', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SHIPMENT_TRACK . '.tracking_number',
                        ));
                    }
                    break;
                ...
                case 'shipped':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipped', array(
                            ...
                            'index' => 'shipped',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SHIPMENT_GRID . '.shipped',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_amount':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_amount', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER . '.shipping_amount'
                        ));
                    }
                    break;
                ...
                case 'base_shipping_amount':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('base_shipping_amount', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER . '.base_shipping_amount'
                        ));
                    }
                    break;
                ...
                case 'subtotal':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('subtotal', array(
                            ...
                            'index' => 'subtotal',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER . '.subtotal'
                        ));
                    }
                    break;
                ...
                case 'base_subtotal':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('base_subtotal', array(
                            ...
                            'index' => 'base_subtotal',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER . '.base_subtotal'
                        ));
                    }
                    break;
                ...
                case 'billing_company':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_company', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.company',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_company':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_company', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.company',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_street':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_street', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.street',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_street':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_street', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.street',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_city':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_city', array(
                            ...
                            'index' => 'billing_city',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.city',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_city':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_city', array(
                            ...
                            'index' => 'shipping_city',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.city',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_region':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_region', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.region',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_region':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_region', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.region',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_country':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_country', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.country_id',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_country':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_country', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.country_id',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_postcode':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_postcode', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.postcode',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_postcode':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_postcode', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.postcode',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'billing_telephone':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('billing_telephone', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_BILLING . '.telephone',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'shipping_telephone':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('shipping_telephone', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_ORDER_ADDRESS_SHIPPING . '.telephone',
                            'align' => 'center'
                        ));
                    }
                    break;
                ...
                case 'order_comment':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('order_comment', array(
                            ...
                            'index' => 'order_comment',
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_TEMP_SALES_ORDER_COMMENTS . '.order_comment'
                        ));
                    }
                    break;
                ...
                case 'invoice_increment_id':
                    if (in_array($column, $listColumns)) {
                        $block->addColumn('invoice_increment_id', array(
                            ...
                            'filter_index' => MageWorx_OrdersGrid_Model_Grid::TABLE_SALES_INVOICE . '.invoice_increment_id'
                        ));
                    }
                    break;
            }
