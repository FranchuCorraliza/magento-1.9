...
} elseif (MageWorx_OrdersEdit_Helper_Data::foeModuleCheck('Viabill_Payepay', 'Viabill_Payepay_Block_Adminhtml_Sales_Order_View', 'Mage_Adminhtml_Block_Sales_Order_View')) {
