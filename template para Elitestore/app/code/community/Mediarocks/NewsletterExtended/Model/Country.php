...
class Mediarocks_NewsletterExtended_Model_Country extends Mage_Core_Model_Abstract
{
    /**
     * Channel model
     *
    ...
    {
        $this->_init('mediarocks_newsletterextended/country');
    }
	
	public function getCountry()
    {
        if (!isset($this->country)) {
            $this->country = Mage::getModel('mediarocks_newsletterextended/country')->load($this->getCountryId());
        }
