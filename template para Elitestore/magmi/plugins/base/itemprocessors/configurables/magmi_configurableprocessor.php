...
class Magmi_ConfigurableItemProcessor extends Magmi_ItemProcessor
{
    ...
    public function processItemBeforeId(&$item, $params = null)
    {
        ...
        if (array_key_exists("type",$item) && $item["type"] !== "configurable") {
            return true;
        }
        if ($this->_use_defaultopc ||
             (array_key_exists("options_container",$item) && ($item["options_container"] != "container1" && $item["options_container"] != "container2"))) {
