...
$jsq(function() {
    ...
    $jsq('#esns_box_close').css('margin-top', (($jsq(window).height()-$jsq('#esns_box_layer').height()) /2)+'px');	
	$jsq('#esns_box_layer_us').css('margin-top', (($jsq(window).height()-$jsq('#esns_box_layer_us').height()) /2)+'px');
