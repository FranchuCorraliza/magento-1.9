...
//	Comprobamos si se está aplicando alguna promoción excluyente de free shipping
		$promocionesExcluidas= array (118,119,120,114,113,111,108,107,106,102);
		...
		endforeach;
		if ((($request->getFreeShipping()) || ($grandTotal >= $this->getConfigData('free_shipping_subtotal'))) && !$excluir) {
