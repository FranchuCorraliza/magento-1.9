...
/* Añadimos este código para asignar las categorías correctas en función de la familia, sección y departamento de cada producto */
				...
				case '1':
						...
						switch ($importData['seccion']){
							...
							case '5':
									switch ($importData['familia']){
										case '1':
												$categorias=array('23','206','207');
												$weight='0.5000';
											break;
										case '2':
												$categorias=array('23','206','208');
												$weight='0.5000';
											break;
										case '3':
												$categorias=array('23','206','209');
												$weight='0.5000';
											break;
										case '4':
												$categorias=array('23','206','210');
												$weight='0.5000';
											break;
										case '5':
												$categorias=array('23','206','211');
												$weight='0.5000';
											break;
										case '6':
												$categorias=array('23','206','212');
												$weight='0.5000';
											break;
										case '7':
												$categorias=array('23','206','213');
												$weight='0.5000';
											break;
										case '8':
												$categorias=array('23','206','214');
												$weight='0.5000';
											break;
									}
								break;
				...
				case '2':
						switch ($importData['seccion']){
							...
							case '5':
									switch ($importData['familia']){
										case '1':
												$categorias=array('62','215','216');
												$weight='0.5000';
											break;
										case '2':
												$categorias=array('62','215','217');
												$weight='0.5000';
											break;
										case '3':
												$categorias=array('62','215','218');
												$weight='0.5000';
											break;
										case '4':
												$categorias=array('62','215','219');
												$weight='0.5000';
											break;
										case '5':
												$categorias=array('62','215','220');
												$weight='0.5000';
											break;
										case '6':
												$categorias=array('62','215','221');
												$weight='0.5000';
											break;
										case '7':
												$categorias=array('62','215','222');
												$weight='0.5000';
											break;
										case '8':
												$categorias=array('62','215','223');
												$weight='0.5000';
											break;
									}
								break;
				...
				case '4':
						switch ($importData['seccion']){
							...
							case '2':
									switch ($importData['familia']){
										case '1':
												$categorias=array('101','224','226');
												$weight='0.5000';
											break;
										case '2':
												$categorias=array('101','224','227');
												$weight='0.5000';
											break;
									}
								break;
							case '3':
									switch ($importData['familia']){
										case '1':
												$categorias=array('101','225','228');
												$weight='0.5000';												
											break;
										case '2':
												$categorias=array('101','225','229');
												$weight='0.5000';			
											break;
									}
								break;
	...
	/******************************************************************************/
        ...
        foreach ( $inventoryFields as $field ) {
        	//echo "entro simple";
            if ( isset( $importData[$field] ) && $importData[$field]!= '') {
	...
	// Código añadido para Insertar correctamente las imagenes
			...
			if ($is_file){
				...
				if ($ruta2==$ruta){ //importamos la 2ª imagen
					echo ('insertando back en ruta:'.$ruta);
					$gallery = $product->getData('media_gallery');
					$lastImage = array_pop($gallery['images']);
					$lastImage['label'] = 'back';
       ...
       // $product->setWebsiteIDs(array(1));
		...
		$product -> setData('no_shop_button', false);
		$product -> setData('es_musica', false);
		$product -> setData('seccion_especial', false);
		$product -> setData('solo_envio_eu', false);
		$product -> setData('pre_order_item', false);
		$product -> setData('has_four_images', false);
...
Mage::log('My log entry'. $importData['sku'] , null, 'mylogfile.log');		
		$product = new Mage_Catalog_Model_Product();
 		$product -> setData( array() );
		...
		$product->setData('description', $importData['campo_uno']);
		$product->setPrice($importData["price"]);
		$product->setSpecialPrice($importData["special_stockprice"]);
