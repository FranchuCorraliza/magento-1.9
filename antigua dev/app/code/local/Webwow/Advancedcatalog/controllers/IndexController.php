...
class Webwow_Advancedcatalog_IndexController extends Mage_Core_Controller_Front_Action
{
        ...
        public function sendemailAction()
    {
        ...
        $mail->setSubject('concurso Yeezy Talla '. $params['talla'].'UK');
		
		
		$mail2 = new Zend_Mail();
        $mail2->setBodyHtml("Thank you for signing up! This is to confirm your participation in our YEEZY BOOOST 350 BLACK Raffle.<br/> 
 
FRIDAY is the day! In case you&acute;re one of the lucky winners, we&acute;ll call you and drop you a line with the private link to finish your purchase. <br/>
 
Until then: FINGERS (AND TOES) CROSSED!<br/>
 
We all wish you the best of luck,<br/>
 
ELITE Store<br/>
<br/>
 
P.S.<br/>
On Friday, Feb 19, the winners will also be published on <a href='http://www.frivolidays.com'>Frivolidays.com</a> and our social media.
");
        $mail2->setFrom("info@elitestore.es", "Elite Store");
        $mail2->addTo($params['email'], 'Recibido');
        $mail2->setSubject('CONFIRMATION: YEEZY BOOOST 350 BALCK, SIZE '. $params['talla']);
