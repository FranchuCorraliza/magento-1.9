...
class Mage_Paypal_Block_Express_Form extends Mage_Paypal_Block_Standard_Form
{
    ...
    protected function _construct()
    {
        ...
        $this->setRedirectMessage("<div style='text-align:center;width:100%'><img src='https://www.elitestore.es/media/wysiwyg/formas-de-pago.png' style='width:90%;margin-bottom:15px'><br /><strong>" . Mage::helper('paypal')->__('You will be redirected to the PayPal website.') . "</strong></div>");
        return $result;
    }
