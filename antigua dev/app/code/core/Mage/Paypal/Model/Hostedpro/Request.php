...
class Mage_Paypal_Model_Hostedpro_Request extends Varien_Object
{
    ...
    {
		// Editado para definir idioma de la pasarela en función del idioma de la página.
		if ((Mage::app()->getStore()->getStoreId()==2) || (Mage::app()->getStore()->getStoreId()==3)){
			$lang='en_US';
		}else{
			$lang='es_ES';
		}
    ...
    protected function _getBillingAddress(Varien_Object $address)
    {
        $request = array(
            ...
            'billing_state'     => $address->getRegionCode(),
